<template>
    <div>
        <div v-if="!loading">
            <img class="rounded mx-auto d-block" :src="image" alt="image">
        </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input v-model="task.content" type="text" id="content" class="form-control">
                            </div>
                        </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="content">Description</label>
                                <input v-model="new_update_task.content" type="text" id="content" class="form-control">
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        ...
        methods:{
            ...
            updateTask(){
                ...
                axios.patch(this.uri + this.new_update_task.id, {
                    ...
                    content: this.new_update_task.content
                }).then(response => {
